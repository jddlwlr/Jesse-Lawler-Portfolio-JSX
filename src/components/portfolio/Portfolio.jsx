            ...
            <div className="col-lg-8 col-xl-6">
              <div className="text-center">
                ...
                <p className="lead fw-normal text-muted mb-5">
                  Take a look at a few of the projects I've worked on recently.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="col-lg-4 mb-5">
              <div className="card h-100 shadow border-0">
                ...
                <div className="card-body p-4">
                  ...
                  <p className="card-text mb-0">
                    A web application for scheduling ones day built using local
                    storage, JavaScript, HTML and CSS.
                  </p>
                </div>
                <div className="card-footer p-4 pt-0 bg-transparent border-top-0">
                  <div className="d-flex align-items-end justify-content-between">
            ...
            <div className="col-lg-4 mb-5">
              <div className="card h-100 shadow border-0">
                ...
                <div className="card-body p-4">
                  ...
                  >
                    <h5 className="card-title mb-3">
                      A simple application used to display weather data based on
                      user input.
                    </h5>
                  </a>
                </div>
